    ...
    function bindEvents() {
        ...
        if (toggleLegacyFx) {
            toggleLegacyFx.onclick = function () {
                ...
                setText('v2NostalgiaResult', legacyFxOn ? '2012 glow mode enabled.' : '2012 glow mode disabled.');
            };
        }
        ...
        if (tickerPreset) {
            tickerPreset.onclick = function () {
                ...
                setText('v2NostalgiaResult', '2012 ticker preset loaded for classic operator branding.');
            };
        }

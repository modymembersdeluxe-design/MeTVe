(function () {
    ...
    function wireLegacyMenu() {
        ...
        var links = ['menuNewChannel','menuGoLive','menuUpload','menuPromo','menuLogs','menuSync','menuV2'];
        ...
        if (byId('menuV2')) {
            byId('menuV2').onclick = function () { setMenuHint('Opening MeTVe V2 page.'); return true; };
        }
    }
